...
@Component({
  ...
  imports: [RouterLink],
  template: `
    <main class="page"><section class="card"><h2>NDI Reports</h2><p>Bekijk, voeg toe of verwijder NDI reports per hole.</p><div class="actions"><a routerLink="/corrosion" class="btn">Open NDI workflow</a><a routerLink="/" class="btn ghost">Terug</a></div></section></main>
  `,
